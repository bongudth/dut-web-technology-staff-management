<?php
    ...
    switch ($key) {
        case "idnv":
            ...
            break;
        case "hoten":
            $sql = "SELECT * FROM nhanvien WHERE hoten = '$value'";
            break;
        case "idpb":
            $sql = "SELECT * FROM nhanvien WHERE idpb = $value";
            break;
        case "diachi":
            $sql = "SELECT * FROM nhanvien WHERE diachi = '$value'";
            break;
    }
...
<html lang="en">
    <body>
        ...
        <a class="button" href="./timkiem.php">Return</a>
    </body>
